...
1. Consultation de Profil (Hybride)
...

{
  ...
  "role": "jeune",
  "bio": "Étudiant en informatique, disponible pour aider."
}


2. Consultation de Profil (API Dédiée)
...
1. Lister les créneaux disponibles
